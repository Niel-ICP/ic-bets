...
import { idlFactory } from "./betting_backend.did.js";
export { idlFactory } from "./betting_backend.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BETTING_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./betting_backend.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the betting_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./betting_backend.did.js")._SERVICE>}
*/
export const betting_backend = createActor(canisterId);
