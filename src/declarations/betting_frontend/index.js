...
import { idlFactory } from "./betting_frontend.did.js";
export { idlFactory } from "./betting_frontend.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BETTING_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./betting_frontend.did.js")._SERVICE>} ActorSubclass configured for the canister
 */
...
/**
 * A ready-to-use agent for the betting_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./betting_frontend.did.js")._SERVICE>}
*/
export const betting_frontend = createActor(canisterId);
